...
export default {
    ...
    data() {
        return {
            projects: [
                { id:'1', nome: 'Spotify Web Replica', description: 'Riproduzione responsive del layout di Spotify Web', video: require('@/assets/video/demo_spotify.mp4') },
                { id:'2', nome: 'WhatsApp Web Replica', description: 'Riproduzione responsive del layout di Whatsapp Web, con alcune funzioni come ricerca di utenti di una lista, invio di un messaggio con ricezione di una risposta "ok", timestamp di invio messaggio e eliminazione messaggi', video: require('@/assets/video/demo_whatsapp.mp4') },
                ...
                { id:'4', nome: 'BoolPress', description: 'Applicazione Web che simula un blog simil Wordpress, con registrazione utente e CRUD per creare/modificare/eliminare degli articoli', video: require('@/assets/video/demo_boolpress.mp4') },
                { id:'5', nome: 'BoolBnB', description: 'Applicazione Web che permette di registrarsi ed inserire appartamenti in vendita/affitto, presente funzione di sponsorizzazione con utilizzo di Braintree, funzione di messaggistica e ricerca di appartamenti in base alla zona ricercata', video: require('@/assets/video/demo_boolbnb.mp4') },
